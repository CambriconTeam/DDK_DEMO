...
CaffeMobile *CaffeMobile::Get(const string &model_path,
  ...
  if (!caffe_mobile_ || model_path != model_path_ ||
    ...
    caffe_mobile_ = new CaffeMobile(model_path, weights_path,mode);
...
CaffeMobile::CaffeMobile(const string &model_path, const string &weights_path,const bool &mode) {
...
int main(int argc, char const *argv[]) {
  ...
  CaffeMobile *caffe_mobile =
      CaffeMobile::Get(string(argv[1]), string(argv[2]),true);
