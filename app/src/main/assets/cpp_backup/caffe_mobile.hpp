...
public:
  ...
  static CaffeMobile *Get(const string &model_path, const string &weights_path,const bool &mode);
...
private:
  ...
  CaffeMobile(const string &model_path, const string &weights_path,const bool &mode);
